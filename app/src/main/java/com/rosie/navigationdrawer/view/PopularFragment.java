...
import com.rosie.navigationdrawer.server.MainData2;
...
public class PopularFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        progressBar = rootView.findViewById(R.id.progress_bar_pop);

        MainData2 viewModel = ViewModelProviders.of(this).get(MainData2.class);
        viewModel.getDatas2().observe(this, getPopData);

        showLoading(true);
        viewModel.getDataList2("popular");
    ...
    private Observer<ArrayList<Model>> getPopData = new Observer<ArrayList<Model>>() {
        @Override
